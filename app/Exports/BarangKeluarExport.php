...
class BarangKeluarExport implements WithEvents, WithStyles
{
    protected $request;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('C10', 'Tanggal Keluar');
                $sheet->setCellValue('D10', 'Nama Barang');
                $sheet->setCellValue('E10', 'Jumlah Keluar');
                ...
                $data = $query->orderBy('tanggal_keluar')->get();
